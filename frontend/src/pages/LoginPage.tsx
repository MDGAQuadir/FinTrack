...
export function LoginPage() {
  ...
  // Clear OTP input on step change
  useEffect(() => {
    setOtpValue('otp', '')
  }, [step, setOtpValue])
        ...
        {step === 'otp' && (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-zinc-900 dark:text-white mt-2">Verify Code</h1>
              <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                We found your account! We sent a 6-digit OTP code to <strong className="text-zinc-800 dark:text-zinc-200">{email}</strong>.
              </p>
            </div>
            ...
            <form onSubmit={handleOtpSubmit(onOtpSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-zinc-400 dark:text-zinc-500" />
                  <input
                    type="text"
                    maxLength={6}
                    ...
                    className="w-full pl-10 pr-4 py-3 md:py-2.5 bg-slate-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-indigo-500/80 rounded-lg text-base md:text-sm tracking-widest font-mono text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none transition-colors disabled:opacity-50 font-bold"
                  />
                </div>
                {otpErrors.otp && (
                  <span className="text-[11px] text-rose-500 dark:text-rose-400">{otpErrors.otp.message}</span>
                )}
              </div>
            ...
            <form onSubmit={handleRegisterSubmit(onRegisterSubmit)} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 md:py-2.5 bg-slate-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-indigo-500/80 rounded-lg text-base md:text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none transition-colors disabled:opacity-50"
                  />
                </div>
                {registerErrors.Name && (
              ...
              <div className="space-y-1.5">
                ...
                {registerErrors.Phone && (
                  <span className="text-[11px] text-rose-500 dark:text-rose-400">{registerErrors.Phone.message}</span>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {registerErrors.Occupation && (
                  <span className="text-[11px] text-rose-500 dark:text-rose-400">{registerErrors.Occupation.message}</span>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {registerErrors.City && (
                  <span className="text-[11px] text-rose-500 dark:text-rose-400">{registerErrors.City.message}</span>
                )}
              </div>
              ...
              <div className="space-y-1.5 opacity-60">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    readOnly
                    value={email}
                    className="w-full pl-10 pr-4 py-3 md:py-2.5 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg text-base md:text-sm text-zinc-600 dark:text-zinc-400 focus:outline-none"
                  />
                </div>
              </div>
        ...
        {step === 'register-otp' && (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-zinc-900 dark:text-white mt-2">Verify Registration</h1>
              <p className="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
